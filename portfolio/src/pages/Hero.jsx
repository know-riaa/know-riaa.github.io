      ...
      <>
        <motion.div ref={containerRef} className='relative min-h-screen overflow-hidden text-white'>
          <motion.div 
            ...
            className='flex items-center justify-center h-screen hover:animate-pulse hover:text-red-500'>
              <div className='text-center hover:animate-pulse hover:text-red-500'>
                <div className='text-5xl md:text-9xl font-big'>
                  <Link to='/about' className='inline-block m-0'>
                    RIA THAPA.
                  </Link>
                </div>
              </div>
        ...
        <motion.div style={{ opacity: roleOpacity}}
          className='fixed top-60 md:top-72 left-0 right-0 z-40 backdrop-blur-sm bg-black/50'>
        ...
        className='fixed bottom-64 left-1/2 -translate-x-1/2 md:bottom-80 flex gap-8 md:gap-28 font-big text-2xl md:text-6xl w-fit pointer-events-none'>
